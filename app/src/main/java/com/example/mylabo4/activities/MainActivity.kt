package com.example.mylabo4.activities
...
import com.example.mylabo4.R
import com.example.mylabo4.adapters.MovieAdapter
import com.example.mylabo4.network.NetworkUtils
import com.example.mylabo4.pojos.Movie
            ...
            if (movieInfo != null) {
                if (!movieInfo.isEmpty()) {
                    ...
                    if (movieJson.getString("response") == "True") {
                        ...
                        Snackbar.make(main_ll, "", Snackbar.LENGTH_SHORT).show()
                    }
                }
            }
        }
